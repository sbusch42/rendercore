...
#include <rendercore/base/AbstractContext.h>
...
*    Have a look at rendercore-glfw or rendercore-qt to find default implementations for the respective framework.
*/
class RENDERCORE_API AbstractGLContext : public AbstractContext
{
public:
    /**
    *  @brief
